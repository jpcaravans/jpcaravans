...
function AboutSection() {
   ...
   return (
    ...
    xl:px-16 ">
        ...
        <p className='text-white text-xl lg:text-2xl xl:mt-12'> bei JP Caravans! Wir sind dein Partner im Bereich des autarken Campens und weiterem Zubehör für deinen Wohnwagen, Wohnmobil oder Van in den Regionen Gifhorn, Wolfsburg und Braunschweig.
        <br/>
        <br/>
